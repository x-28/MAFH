...
def loading_data():
    file = h5py.File('D:/lixue/cross-modal/20220812DCMH/MESDCH-master/dataset/data/mirflickr/IAll/mirflickr25k-iall.mat')
    images = (file['IAll'][:].transpose(0, 1, 3, 2) / 255.0).astype(np.float32)
    tags = loadmat('D:/lixue/cross-modal/20220812DCMH/MESDCH-master/dataset/data/mirflickr/YAll/mirflickr25k-yall.mat')['YAll'].astype(np.float32)
    labels = loadmat('D:/lixue/cross-modal/20220812DCMH/MESDCH-master/dataset/data/mirflickr/LAll/mirflickr25k-lall.mat')['LAll'].astype(np.float32)
    file.close()
